...
var GaleriePage = /** @class */ (function () {
    function GaleriePage(navCtrl, navParams) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
    }
    GaleriePage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad GaleriePage');
    };
    GaleriePage.prototype.doRefresh = function (refresher) {
